...
class ProvisionsManagerSolution:
    ...
    def _se_centro_custo_esta_no_mes_anterior(self, centro_custo_procurado):
        for empresa in self.folha_pagto[0].empresas:
            for centro_custo in empresa.centros_custos:
                if centro_custo.nome == centro_custo_procurado.nome:
                    return centro_custo
        return False
        ...
        for empresa in self.folha_pagto[1].empresas:
            ...
            if self._se_empresa_esta_no_banco_dados(empresa):
                ...
                if self.empresa_origem:
                    print(f'empresa: {empresa.cnpj}, empresa origem {
                          self.empresa_origem.cnpj}')
                    for centro_custo in empresa.centros_custos:
                        if self._se_centro_custo_cadastrado_banco_dados(
                            ...
                            if self.centro_custo_origem:
                                ...
                                print(f'empresa', empresa.cnpj)
                                print(f'saldos', centro_custo.vlr_saldo_provisao_13,
                                      self.centro_custo_origem.vlr_saldo_provisao_13)
